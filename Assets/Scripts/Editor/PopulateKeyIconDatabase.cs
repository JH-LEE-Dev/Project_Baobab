...
public class PopulateKeyIconDatabase
{
    ...
    public static void Populate()
    {
        ...
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/leftStick", "PadLStick_Full", "PadLStick_None", "LStick_None");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/leftStick/up", "PadLStick_Up", "LStick_Up");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/leftStick/down", "PadLStick_Down", "LStick_Down");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/leftStick/left", "PadLStick_Left", "LStick_Left");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/leftStick/right", "PadLStick_Right", "LStick_Right");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/leftStickPress", "PadLStick_Click", "LStick_Click");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/rightStick", "PadRStick_Full", "PadRStick_None", "RStick_None");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/rightStick/up", "PadRStick_Up", "RStick_Up");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/rightStick/down", "PadRStick_Down", "RStick_Down");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/rightStick/left", "PadRStick_Left", "RStick_Left");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/rightStick/right", "PadRStick_Right", "RStick_Right");
        AddEntryWithFallback(_xboxEntries, _gamepadSprites, "<Gamepad>/rightStickPress", "PadRStick_Click", "RStick_Click");
        ...
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/leftStick", "PadLStick_Full", "PadLStick_None", "LStick_None");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/leftStick/up", "PadLStick_Up", "LStick_Up");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/leftStick/down", "PadLStick_Down", "LStick_Down");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/leftStick/left", "PadLStick_Left", "LStick_Left");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/leftStick/right", "PadLStick_Right", "LStick_Right");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/leftStickPress", "PadLStick_Click", "LStick_Click");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/rightStick", "PadRStick_Full", "PadRStick_None", "RStick_None");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/rightStick/up", "PadRStick_Up", "RStick_Up");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/rightStick/down", "PadRStick_Down", "RStick_Down");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/rightStick/left", "PadRStick_Left", "RStick_Left");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/rightStick/right", "PadRStick_Right", "RStick_Right");
        AddEntryWithFallback(_psEntries, _gamepadSprites, "<Gamepad>/rightStickPress", "PadRStick_Click", "RStick_Click");
