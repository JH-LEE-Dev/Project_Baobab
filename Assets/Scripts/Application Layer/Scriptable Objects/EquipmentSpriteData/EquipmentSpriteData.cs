...
public class EquipmentSpriteData : ScriptableObject
{
    ...
    // 빠른 조회를 위한 딕셔너리 캐싱
    private Dictionary<EquipmentType, EquipmentSprite> spriteCache;
    ...
    public void Initialize()
    {
        ...
        spriteCache = new Dictionary<EquipmentType, EquipmentSprite>();
    ...
    public bool TryGetSprites(EquipmentType _type, out Sprite _main, out Sprite _sub)
    {
        Initialize();
