Shader "Custom/2D/Particle-Lit-HDR"
{
    Properties
    {
        ...
        [HDR] _HDRColor("HDR Base Color", Color) = (1,1,1,1)
        _HDRIntensity("HDR Multiplier Intensity", Float) = 1

        [Header(Pixel Snap)]
        [Toggle(PIXELSNAP_ON)] _PixelSnap("Enable Pixel Snap", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            UNITY_INSTANCING_BUFFER_START(UnityPerMaterial)
                ...
                UNITY_DEFINE_INSTANCED_PROP(half4, _HDRColor)
            ...
            half4 LitFragment(Varyings input) : SV_Target
            {
                ...
                // 적용된 HDR 로직 (Color * Intensity)
                half4 hdrColor = UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _HDRColor);
                float hdrInt = UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _HDRIntensity);
                color.rgb *= hdrColor.rgb * hdrInt;
