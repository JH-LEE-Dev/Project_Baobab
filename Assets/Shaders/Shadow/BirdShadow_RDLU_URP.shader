Shader "Custom/BirdShadow_RDLU_URP"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes IN)
            {
                ...
                float originalX = positionOS.x;
                positionOS.x += positionOS.y * _SkewX;
                positionOS.y += originalX * _SkewY;

                OUT.positionHCS = TransformObjectToHClip(positionOS.xyz);
                OUT.worldPos = TransformObjectToWorld(positionOS.xyz);
                OUT.uv = IN.uv;
                return OUT;
            }
